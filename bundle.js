...
(function (global) {
  ...
  /**
   * Action for drawing an code block.
   */
  function drawCodeBlock(editor) {
    var cm = editor.codemirror;
    var stat = getState(cm);
   ...
   * Preview action.
   */
  function saveTextAsFile(editor) {
    //debugger;
    var cm = editor.codemirror;
    textToWrite = cm.getValue();
    var textFileAsBlob = new Blob([textToWrite], { type: 'text/plain' });
    var fileNameToSaveAs = "file.md"; //filename.extension
  ...
  var toolbar = [
    ...
    { name: 'code', action: drawCodeBlock },
    '|',
    ...
    { name: 'download', tooltip: 'download', action: saveTextAsFile },
    { name: 'md-table', tooltip: 'md-table', action: 'https://www.tablesgenerator.com/markdown_tables' },
    { name: 'fullscreen', action: toggleFullScreen }
  ];

  /**
   * Customization Interface of Markey.
   */
  function Markey(options) {
    ...
    options.toolbar = options.toolbar || Markey.toolbar;
   ...
   */
  Markey.toolbar = toolbar;

  /**
   * Default markdown render.
   */
  Markey.markdown = function (text) {
    if (window.marked) {
   ...
   */
  Markey.prototype.render = function (el) {
    if (!el) {
  ...
  Markey.prototype.createToolbar = function (items) {
  ...
  Markey.prototype.createStatusbar = function (status) {
   ...
   */
  Markey.prototype.value = function (val) {
    if (val) {
   ...
   */
  Markey.toggleBold = toggleBold;
  Markey.toggleItalic = toggleItalic;
  Markey.toggleBlockquote = toggleBlockquote;
  Markey.toggleUnOrderedList = toggleUnOrderedList;
  Markey.toggleOrderedList = toggleOrderedList;
  Markey.drawLink = drawLink;
  Markey.drawImage = drawImage;
  Markey.drawCodeBlock = drawCodeBlock;
  Markey.undo = undo;
  Markey.redo = redo;
  Markey.togglePreview = togglePreview;
  Markey.saveTextAsFile = saveTextAsFile;
  Markey.toggleFullScreen = toggleFullScreen;

  /**
   * Bind instance methods for exports.
   */
  Markey.prototype.toggleBold = function () {
    toggleBold(this);
  };
  Markey.prototype.toggleItalic = function () {
    toggleItalic(this);
  };
  Markey.prototype.toggleBlockquote = function () {
    toggleBlockquote(this);
  };
  Markey.prototype.toggleUnOrderedList = function () {
    toggleUnOrderedList(this);
  };
  Markey.prototype.toggleOrderedList = function () {
    toggleOrderedList(this);
  };
  Markey.prototype.drawLink = function () {
    drawLink(this);
  };
  Markey.prototype.drawImage = function () {
    drawImage(this);
  };
  Markey.prototype.drawCodeBlock = function () {
    drawCodeBlock(this);
  };
  Markey.prototype.undo = function () {
    undo(this);
  };
  Markey.prototype.redo = function () {
    redo(this);
  };
  Markey.prototype.togglePreview = function () {
    togglePreview(this);
  };
  Markey.prototype.toggleFullScreen = function () {
    toggleFullScreen(this);
  };
  Markey.prototype.saveTextAsFile = function () {
    saveTextAsFile(this);
  };

  global.Markey = Markey;
})(this);
